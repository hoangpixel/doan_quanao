 ...
 * @author mhoang
 */
public class ctkmhdGUI_Click extends javax.swing.JDialog {
    ...
    public ctkmhdGUI_Click(java.awt.Frame parent,boolean modal, int mactkm)
    {
        super(parent,modal);
        this.mactkm = mactkm;
        initComponents();
    ...
    public void headerTable()
    {
        ...
        tbCTKMHD.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
}

        //căn header ra center
        JTableHeader headerTB = tbCTKMHD.getTableHeader();
    ...
    {
        model.setRowCount(0);
        for(ChuongTrinhKhuyenMaiHoaDonDTO ct : dskq)
        {
    ...
    public void dsCTKMSP() 
    {
        ...
        if(ChuongTrinhKhuyenMaiHoaDonBUS.ds == null)
        {
            updateTB(bus.layTatCaCTKMHD());
        }
        kq = bus.layTheoMaCTKMHD(mactkm);
        updateTB(kq);
    }
    /**
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Theo mã CTKMHD", "Theo tổng tiền HD", "Theo PTGG" }));
        ...
        tbCTKMHD.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tbCTKMHD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbCTKMHDMouseClicked(evt);
            }
        });
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(tim.isEmpty())
        {
            String mess = "Vui lòng nhập dữ liệu cần tìm!";
            JLabel lbTim = new JLabel(mess);
            lbTim.setFont(new Font("Segoe UI",Font.BOLD,16));
            JOptionPane.showMessageDialog(this, lbTim,"Thông báo",JOptionPane.ERROR_MESSAGE);        
        }
        ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> dskq = new ArrayList<>();
        int i = jComboBox1.getSelectedIndex();
        for(ChuongTrinhKhuyenMaiHoaDonDTO ct : kq)
        {
            switch(i)
            {
                case 0:
                {
                    if(String.valueOf(ct.getMaCTKMHD()).contains(tim))
                    {
                        dskq.add(ct);
                    }
                    break;
                ...
                case 1:
                {
                    if(String.valueOf(ct.getSoTienHD()).contains(tim))
                    {
                        dskq.add(ct);
                    }
                    break;
                ...
                case 2:
                {
                    if(String.valueOf(ct.getPhanTramGiamGia()).contains(tim))
                    {
                        dskq.add(ct);
                    }
                    break;
    ...
    private void tbCTKMHDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCTKMHDMouseClicked
        // TODO add your handling code here:

    }//GEN-LAST:event_tbCTKMHDMouseClicked
    ...
    public ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> getDsctkmhd()
    {
        return kq;
    }
    /**
