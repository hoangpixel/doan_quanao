 ...
 * @author suvie
 */
public class SuaQuan extends javax.swing.JDialog {

    /**
     * Creates new form SuaQuan
     */
    private boolean xacNhanSua = false;
    private int malsp;
    public SuaQuan(java.awt.Frame parent, boolean modal, int malsp) {
        super(parent, modal);
        this.malsp = malsp;
        initComponents();
        loadQuan(malsp);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHỈNH SỬA QUẦN");
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        new QuanBUS().sua(q);
        xacNhanSua = true;
        JOptionPane.showMessageDialog(this, "Cập nhật thông tin quần thành công!");
        dispose();
    ...
    public void loadQuan(int malsp) {
