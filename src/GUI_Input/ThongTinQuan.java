 ...
 * @author suvie
 */
public class ThongTinQuan extends javax.swing.JDialog {

    /**
     * Creates new form ThongTinQuan
     */
    private int malsp;
    public ThongTinQuan(java.awt.Frame parent, boolean modal, int malsp) {
        super(parent, modal);
        this.malsp = malsp;
        initComponents();
        loadQuan();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("THÔNG TIN QUẦN");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtTenQuan, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
    ...
    private void loadQuan() {
        QuanDTO q = new QuanBUS().layQuanTheoMa(malsp);
        txtMaLoai.setText(String.valueOf(q.getMaLoai()));
        txtTenQuan.setText(q.getTenQuan());
        
        //Chỉ xem, không được chỉnh sửa, không được focus
        txtMaLoai.setEditable(false);
        txtTenQuan.setEditable(false);
        
        txtMaLoai.setFocusable(false);
        txtTenQuan.setFocusable(false);
    }
