 ...
 * @author mhoang
 */
public class updateChiTietHoaDon extends javax.swing.JDialog {
    ...
    public updateChiTietHoaDon(java.awt.Frame parent , boolean model, ChuongTrinhKhuyenMaiDTO data) {
        super(parent,model);
        initComponents();
