...
public class ChuongTrinhKhuyenMaiHoaDonDAO {
    ...
    public ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> timKiemTheoMaCTKM(int maCTKM) {
        ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> ds = new ArrayList<>();
        String query = "select * from ctkmhd where MACTKM = ?";
        Connection conn = null;
        try {
            conn = DBConnect.getConnection();
            PreparedStatement st = conn.prepareStatement(query);
    ...
    public ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> timKiemTheoTongTienThapNhat(int tongTienThapNhat) {
        ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> ds = new ArrayList<>();
        String query = "select * from ctkmhd where TONGTIENHD >= ?";
        Connection conn = null;
        try {
            conn = DBConnect.getConnection();
            PreparedStatement st = conn.prepareStatement(query);
            st.setInt(1, tongTienThapNhat);
            ResultSet rs = st.executeQuery();
            while (rs.next()) {                
                ChuongTrinhKhuyenMaiHoaDonDTO ctkmhd = new ChuongTrinhKhuyenMaiHoaDonDTO();
                ctkmhd.setMaCTKM(rs.getInt("MACTKM"));
    ...
    public ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> timKiemTheoTongTienCaoNhat(int tongTienCaoNhat) {
        ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> ds = new ArrayList<>();
        String query = "select * from ctkmhd where TONGTIENHD <= ?";
        Connection conn = null;
        try {
    ...
    public ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> timKiemTheoPTGGThapNhat(int ptgg) {
        ArrayList<ChuongTrinhKhuyenMaiHoaDonDTO> ds = new ArrayList<>();
        String query = "select * from ctkmhd where PTGG >= ?";
        Connection conn = null;
        try {
            conn = DBConnect.getConnection();
            PreparedStatement st = conn.prepareStatement(query);
