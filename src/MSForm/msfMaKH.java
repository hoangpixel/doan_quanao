 ...
 * @author mhoang
 */
public class msfMaKH extends javax.swing.JDialog {
    ...
    public int getMaKH;
    public msfMaKH(java.awt.Frame parent,boolean modal)
    {
        super(parent,modal);
        initComponents();
    ...
    public void headerTable()
    {
        ...
        JTableHeader headerTB = tbKhachHang.getTableHeader();
    ...
    {
        model.setRowCount(0);
        for(KhachHangDTO ct : KhachHangBUS.ds)
        {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Theo mã KH", "Theo họ KH", "Theo tên KH", "Theo SĐT", "Theo địa chỉ", "Theo email" }));
...
public void updateTB(ArrayList<KhachHangDTO> dskq)
{
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for(KhachHangDTO ct : KhachHangBUS.ds)
        {
            switch(i)
            {
                case 0:
                {
                    if(tim.contains(String.valueOf(ct.getMaKH())))
                    {
                        kq.add(ct);
                    }
                    break;
                ...
                case 1:
                {
                    if(ct.getHoKH().toLowerCase().contains(tim.toLowerCase()))
                    {
                        kq.add(ct);
                    }
                    break;
                ...
                case 2:
                {
                    if(ct.getTenKH().toLowerCase().contains(tim.toLowerCase()))
                    {
                        kq.add(ct);
                    }
                    break;
                ...
                case 4:
                {
                    if(ct.getDiaChi().toLowerCase().contains(tim.toLowerCase()))
                    {
                        kq.add(ct);
                    }
                    break;
                ...
                case 5:
                {
                    if(ct.geteMail().toLowerCase().contains(tim.toLowerCase()))
                    {
                        kq.add(ct);
                    }
                    break;
    ...
    private void tbKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKhachHangMouseClicked
        ...
        if(evt.getClickCount() == 2)
        {
            ...
            getMaKH = Integer.parseInt(tbKhachHang.getValueAt(i, 0).toString());
            xacNhan = true;
            dispose();
        }
